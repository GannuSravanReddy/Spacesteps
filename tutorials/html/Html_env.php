      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" style="overflow-y:scroll; max-height:200px;" aria-labelledby="navbarDropdown">
            ...
            <li ><a class="dropdown-item"  href="Html">Intro</a></li>
            <li style="background:#73438a;"><a style="color:#fff;" class="dropdown-item" href="Html_env">Environment</a></li>
...
<!--navigation-->
<center><b><h1>Environment setup</h1></b></center>
<center><b><h5>HTML Tutorials</h5></b></center>

  
<div id="pagbtn"style="width:100%;"><center><span style="position:relative;left:-100px;"><input style="color:#fff;background:#74458a;width:100px;height:40px;border-style:double;border-width:thin;border-color:#74458a;border-radius:5px;" type="button" value="< back" onclick="location.href='Html';"></span><span style="position:relative;left:100px;"><input style="color:#fff;background:#74458a;width:100px;height:40px;border-style:double;border-width:thin;border-color:#74458a;border-radius:5px;" type="button" value="next >" onclick="location.href='Html_env';"></span></center></div>
  <br>
   <div class="videop">
      <div id="player"></div>
       <script>
  ...
  <div class="downv">
   ...
   <h4>Basic example of HTML shown below here.</h4>
     ...
     <h3> Build up your skills and carrer with Spacesteps.</h3><br>
      ...
      <div id="pagebtn"style="width:100%;"><center><span style="position:relative;left:-100px;"><input style="color:#fff;background:#74458a;width:100px;height:40px;border-style:double;border-width:thin;border-color:#74458a;border-radius:5px;" type="button" value="< back" onclick="location.href='Html';"></span><span style="position:relative;left:100px;"><input style="color:#fff;background:#74458a;width:100px;height:40px;border-style:double;border-width:thin;border-color:#74458a;border-radius:5px;" type="button" value="next >" onclick=""></span></center></div>
  </div>
